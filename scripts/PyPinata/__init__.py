...
class PinataPy:
    ...
    def pin_file_to_ipfs(
        self, path_to_file: str, options: tp.Optional[OptionsDict] = None
    ) -> ResponsePayload:
        """
    ...
    def pin_hash_to_ipfs(
        self, hash_to_pin: str, options: tp.Optional[OptionsDict] = None
    ) -> ResponsePayload:
    ...
    def pin_json_to_ipfs(
        self, json_to_pin: tp.Any, options: tp.Optional[OptionsDict] = None
    ) -> ResponsePayload:
        """pin provided JSON"""
